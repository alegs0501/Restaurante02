//
//  EjercicioTableViewController.swift
//  Restaurante02
//
...
class EjercicioTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "Cell", for: indexPath) as! EjercicioTableViewCell
        
        //Configure the cell
        cell.nameLabel.text = restaurantNames[indexPath.row]
        cell.thumbnailImageView.image = UIImage(named: "resta00\(indexPath.row + 1)")
